...
Simula una conversación en la terminal como si fueras un cliente de SOS Laundry Miami.
"""
...
async def main():
    ...
    print()
    print("=" * 55)
    print("   AgentKit — SOS Laundry Miami · Test Local")
    print("=" * 55)
    print()
    ...
    while True:
        ...
        # Obtener historial ANTES de guardar (evita duplicados)
        historial = await obtener_historial(TELEFONO_TEST)

        # Generar respuesta
        print("\nSonia: ", end="", flush=True)
